...
class CD:
    ...
    @property
    def cd_title(self):
        return self.__cd_dummy
    @cd_title.setter
    def cd_title(self,Title):
        self.__cd_dummy = Title 
    ...
    def __str__(self):
        str_new = ''
        str_new = str_new +  str(self.__cd_id) + ', ' + self.__cd_dummy + ', ' + self.__cd_artist +'\n'
        return str_new
...
class FileIO:
    ...
    def save_inventory(file_name, lst_Inventory):
        ...
        for row in lst_Inventory:
             str1 = str(row.__cd_id) + ', ' + row.__cd_dummy + ', ' + row.__cd_artist + '\n'
             file1.write(str1)
        file1.close()   
